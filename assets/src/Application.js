define('application', ['jquery', 'sammy', 'comparisons', 'trends', 'proportions'], function ($, Sammy, Comparisons, Trends, Proportions) {
  ...
  var graphTypes = ['Proportions', 'Trends', 'Comparison'],
    ...
    comparisonGraph = Comparisons,
    trendGraph = Trends,
    proportionGraph = Proportions,
  ...
  */
  ...
  function getComparisonData(ids) {
    ...
    $.getJSON(apiBaseURL + url, function(data) {
      ...
      comparisonGraph.parse(data, ids);
    });
  }
  ...
  function getProportionData(ids) {
    ...
    $.getJSON(apiBaseURL + url, function(data) {
      ...
      proportionGraph.parse(data, ids);
    });
  }
